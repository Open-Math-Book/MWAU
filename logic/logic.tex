...
\begin{enumerate}
    ...
    \wbvfill
\end{enumerate}
\includegraphics[width=3in]{images/MinesweeperImplication03-A.png} \includegraphics[width=3in]{images/MinesweeperImplication03-A.png}
...
\begin{enumerate} \setcounter{enumii}{7}
    ...
    \wbvfill
\end{enumerate}
\includegraphics[width=3in]{images/MinesweeperImplication03-B.png} \includegraphics[width=3in]{images/MinesweeperImplication03-B.png}
...
\begin{enumerate}
	...
	You project is to complete a $(2,3)$ Sudoku pait puzzle and write a description of how you used logic to complete the puzzle, using examples from your specific game.
