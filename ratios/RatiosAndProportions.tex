...
\subsection{Exit Slip}
\begin{enumerate}
\item Convert the average distance between the sun and Earth, 93 million miles, into light years.\wbvfill \Instr{$93,000,000 \div 5,878,625,000,000 = 0.00001582 \dots$ light years}
...
\Instr{$220 \times 0.1813 \div 1.25 = 31.9$ psi}
...
The following photos have been digitally edited so the images look weird. Using the word "ratio" and ratios as appropriate, explain why they look weird and/or what editing has been done to them.
\begin{enumerate}
\item Cantaloupe:
\begin{center}
\includegraphics[width=5in]{images/cantaloupe}
\end{center}
\Instr{  Students should see that the cantaloupe is about 3 times wider than it is tall, giving the cross section a height to width (aspect) ratio of 1:3. The cross section of an actual cantaloupe should have a height to width ratio of about 1:1 since the fruit is more or less spherical.}\wbvfill
\item Hand:
\begin{center}
...
\end{center}
\begin{enumerate}
\item Use the pictures to measure the size of the model automobile, cauliflower, and soccer ball.
\begin{enumerate}
\item model automobile: \Instr{  5"}\wbvfill
\item model cauliflower: \Instr{  1.2"}\wbvfill
\item model soccer ball: \Instr{  0.6"}\wbvfill
\end{enumerate}
\item Approximately what is the true (real-life) size of an automobile, head of cauliflower, and soccer ball?
\begin{enumerate}
\item real automobile: \Instr{  15' or 180"}\wbvfill
\item real cauliflower: \Instr{  7"}\wbvfill
\item real soccer ball: \Instr{  9"}\wbvfill
\end{enumerate}
\item The scale of a miniature (like the automobile, caulilflower, and soccer ball, or a model train set) is often reported as the ratio between the model size and the real life size of that object. A common scale for model trains is 1:87, for example (meaning something that measures 1 inch on the model would measure 87 inches on the full size train). Based on your answers above, what are the scales of the following objects?
\begin{enumerate}
