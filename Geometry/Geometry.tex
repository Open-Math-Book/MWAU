...
\begin{enumerate}
    \item Write a description that turns the figure on the left (the whole) into the part on the right.\\ \raisebox{-1in}{\includegraphics[width=2.5in]{images/rt-trap-start}}\hfill $\longrightarrow$ \hfill \raisebox{-1in}{\includegraphics[width=2.5in]{images/rt-trap-part2}}
    ...
    \wbnewpage
    \item Write a description that turns the figure on the left (the whole) into the part on the right.\\ \raisebox{-1in}{\includegraphics[width=2.5in]{images/rt-trap-start}}\hfill $\longrightarrow$ \hfill \raisebox{-1in}{\includegraphics[width=2.5in]{images/rt-trap-part4}}
...
\item The lighter edges indicate a line that will be folded during the construction. 
\item The pips (dots) are on the faces that will be showing on the outside of the final shape.
\item All blank faces will be woven {\bf under} another piece of paper when completed.
\end{enumerate}

Somewhat better templates for printing are available on the website.

\newpage

\centerline{\includegraphics[height=.95\textheight]{images/D4-pips}}

\newpage

\centerline{\includegraphics[height=.95\textheight]{images/D6-pips}}
...
\fi
\wbnewpage
\item A series of Wet Noodle Diagrams: Each student will be assigned a well known Polyhedra (e.g Octohedron, Dodecahedron, etc.) and asked to perform the following tasks.

\Instr{Polyhedra we suggest giving students are: Octahedron, Square Pyramid, Triangular Prism, Pentagonal Prism, and Square Antiprism. However, this can be applied to any Polyhedron of your choice. }
\begin{enumerate}
